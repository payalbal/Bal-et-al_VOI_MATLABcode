...
%% EVSI ESTIMATION - EXPERIMENTAL APPROACH + MONITORING 1 SPECIES
manage = [1:3; 4:6];
...
for a = 1:2
    ...
    for sp_monit = 1:3
        ...
        for r = 1:length(B)
            ...
            % EVSI - 1
            evsi1(1,r) = get_EVSI_1_exp_spcase(all_mods, managed_mods, mod_prob_all,...
                B(r), c1, c2, q, Start_m1, sp_monit);
...
title('Experimental approach: Monitoring one species')
disp('EVSI plotted');
