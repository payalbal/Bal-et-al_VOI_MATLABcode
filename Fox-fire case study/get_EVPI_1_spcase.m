function [output] = get_EVPI_1_spcase(all_mods, mod_prob_all, B, c1, c2, q, Start_m1)
...
for i = 1:size(all_mods,1)
    ...
    if B == 0
        m1 = 0;
        mod_sp_all(i) = optim_func_evpi1_spcase(m1, B, c1, c2, q, mod);
...
output = sum(mod_sp_all.* mod_prob_all);
